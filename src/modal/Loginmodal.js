    ...
    return (<div className='flex absolute top-[20%] left-[35%] justify-center w-[606px] h-[530px] shadow-md z-10'>
        ...
        <div className={`w-[390px] p-5 ${theme === 'light' ? 'bg-white' : 'bg-[#121212]'} `}>
            ...
            <div className='flex flex-col justify-end'>
                <div className='email'>
                    <h2 className="text-[1.3rem] font-bold">로그인</h2>
                </div>
                <section>
                    <h4 className="mt-4 mb-4 text-[#868E96]">이메일로 로그인</h4>
                    <form className='w-[100%] flex h-12'>
                        <input className={`flex-1 p-4 border border-solid border-gray-600 rounded-l-md text-base focus:outline-none ${theme === 'light' ? 'bg-[#ffffff] text-gray-800' : 'bg-[#1E1E1E] text-white'} `} placeholder='이메일을 입력하세요.' type='text' />
