...
import { isBase, isModal, isRegi } from "../atoms/recoil";
...
const RegiModal = () => {
    ...
    return (
        <div>
            {Regi && (<div className='flex absolute top-[20%] left-[35%] justify-center w-[606px] h-[530px] shadow-md z-100'>
                ...
                <div className="w-[390px] p-5 bg-white ">
                    ...
                    <div className='flex flex-col justify-end'>
                        <div className='email'>
                            <h2 className="text-[1.3rem] font-bold">회원가입</h2>
                        </div>
                        <section>
                            <h4 className="mt-4 mb-4 text-[#868E96]">이메일로 회원가입</h4>
                        ...
                        <section>
                            ...
                            <div className="flex justify-around mt-6">
                                <a href='#' className='w-12 h-12 rounded-3xl items-center justify-center outline-none text-black border-black'>
                                ...
                                <a href='#' className='w-12 h-12 rounded-3xl items-center justify-center outline-none text-white border-[#DEE2E6]'>
                        ...
                        <div className='pt-[40%]'>
                            ...
                            <div class=" inline-block font-bold text-[#12B886] cursor-pointer" tabindex="7" data-testid="switchmode">로그인</div>
                        </div>
                    </div>
                </div>
            </div>)}
